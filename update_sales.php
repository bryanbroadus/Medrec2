...
<head>
	<meta charset="utf-8">
	<title>MedRec - Update Invoice</title>
   ...
   balance_amount();
    ...
    console.log();
     if(parseFloat(document.getElementById('payable_amount').value) >= parseFloat(document.getElementById('payment').value)){
         ...
         document.getElementById('balance').value=parseFloat(document.getElementById('payable_amount').value)-parseFloat(document.getElementById('payment').value);
    }else{
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<ul>
					...
					<li><a href="view_sales.php">View Invoices</a></li>
		 ...
		 $trans_id=  trim($_POST['stockid']);
                                                	...
                                                	$data="Transaction Updated ! Transaction ID $trans_id" ;
				                                     $msg='<p style="color:#153450;font-size:1.2em;font-family:Verdana, Times New Roman, Times, san-serif;">'.$data.'</p><p><a href="view_sales.php"><i class="fa fa-3x fa-rotate-left"></i> Back To Invoices</a></p><p> <a href="dashboard.php"><i class="fa fa-3x fa-home"></i>Go Home</a></p>';//
                                            ?>
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form table"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  ?>
                      <td>Invoice #:</td>
                      <td><input name="stockid" type="text" id="stockid" readonly="readonly" maxlength="200"  class="round regular-width-input" value="<?php echo $line->transactionid   ; ?>" /></td>
                       
                      <td>Date:</td>
                      <td><input  name="date" id="test1" placeholder="" value="<?php echo $line->date ; ?> " type="text" id="name" maxlength="200"  class="round regular-width-input"  /></td>
                      <td><span class="man">*</span>Bill No:</td>
                      <td><input name="bill_no" placeholder="Enter Bill No" type="text" id="bill_no" maxlength="200" value="<?php echo $line->billnumber ; ?> " class="round regular-width-input" /></td>
                       
                    </tr>
                    <tr>
                      <td><span class="man">*</span>Patient Name:</td>
                      <td><input name="supplier" placeholder="Enter Supplier" type="text" id="supplier" value="<?php echo $line->customer_id 	 ; ?> "  maxlength="200"  class="round regular-width-input" /></td>
                       
                      <td>Address:</td>
                      <td><input name="address" placeholder="Enter Address" type="text" value="<?php $quantity = $db->queryUniqueValue("SELECT customer_address FROM customer_details WHERE customer_name='".$line->customer_id."'"); echo $quantity; ?>" id="address" maxlength="200"  class="round regular-width-input"  /></td>
                       
                      <td>contact:</td>
                      <td><input name="contact" placeholder="Enter Contact" type="text" value="<?php $quantity = $db->queryUniqueValue("SELECT customer_contact1 FROM customer_details WHERE customer_name='".$line->customer_id."'"); echo $quantity; ?>" id="contact1" maxlength="200"  class="round regular-width-input" onkeypress="return numbersonly(event)" style="width:120px " /></td>
                  ...
                  <table class="form table" id="display" style="display:none">
                      ...
                      <td><input name=""  type="text" id="total" maxlength="200"  class="round regular-width-input " style="width:120px;  margin-left: 20px" value="<?php echo $category; ?>" /></td>
