...
<head>
	<meta charset="utf-8">
	<title>Ez Stock - Update Purchase</title>
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form table"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
					  ...
					  ?>
                      <td>Stock ID:</td>
                      <td><input name="stockid" type="text" id="stockid" readonly="readonly" maxlength="200"  class="round regular-width-input" value="<?php echo $line->stock_id  ; ?>" /></td>
                    ...
                    <tr>
                      ...
                      <td><input name="supplier" placeholder="Enter Supplier" type="text" id="supplier" value="<?php echo $line->stock_supplier_name 	 ; ?> "  maxlength="200"  class="round regular-width-input" /></td>
                       
                      <td>Address:</td>
                      <td><input name="address" placeholder="Enter Address" type="text" value="<?php $quantity = $db->queryUniqueValue("SELECT supplier_address FROM supplier_details WHERE supplier_name='".$line->stock_supplier_name."'"); echo $quantity; ?>" id="address" maxlength="200"  class="round regular-width-input"  /></td>
                       
                      <td>contact:</td>
                      <td><input name="contact" placeholder="Enter Contact" type="text" value="<?php $quantity = $db->queryUniqueValue("SELECT supplier_contact1 FROM supplier_details WHERE supplier_name='".$line->stock_supplier_name."'"); echo $quantity; ?>" id="contact1" maxlength="200"  class="round regular-width-input" onkeypress="return numbersonly(event)"/></td>
                  ...
                  <table class="form" id="display" style="display:none">
                      ...
                      <td><input name=""  type="text" id="total" maxlength="200"  class="round regular-width-input " style="margin-left: 20px" value="<?php echo $category; ?>" /></td>
                    ...
                    <td>Balance:<input type="text"  class="round" value="<?php echo $line->balance ; ?>" id="balance" name="balance" >               
                      ...
                      <td> &nbsp;</td><td> &nbsp;</td><td> &nbsp;</td><td> &nbsp;</td>
                       <td>Grand Total:<input type="hidden" readonly="readonly" id="grand_total" value="<?php echo $line->subtotal ; ?>" name="subtotal" > 
                        <input type="text" id="main_grand_total" class="round regular-width-input" value="<?php echo $line->subtotal ; ?>" style="text-align:right;width: 120px" >
                    </td>
                  </tr> </table> 
                  <table>
                  <tr> <td>Mode &nbsp;</td><td>
                  ...
                  <td> &nbsp;</td>
                    ...
                    <tr>
                     <td>
                        <input  class="button round green image-right ic-add text-capitalize" type="submit" name="Submit" value="Save">
                     </td>
					 <td>
