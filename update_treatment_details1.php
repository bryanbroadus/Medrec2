...
function numbersonly(e){
    ...
    $('<tr id='+item+'><td><input type=hidden value='+item+' id='+item+'id ><input type=text name="stock_name[]"  id='+item+'st style="width: 250px;" class="round  my_with" ></td><td><input type=text name=quty[] readonly="readonly" value='+quty+' id='+item+'q class="round  my_with" style="text-align:right; width:60px;" ></td><td><input type=text name=sell[] readonly="readonly" value='+sell+' id='+item+'s class="round  my_with" style="text-align:right; width:100px;"  ></td><td><input type=text name=jibi[] readonly="readonly" value='+total+' id='+item+'to class="round  my_with" style="width: 100px;margin-left:20px;text-align:right;" ><input type=hidden name=total[] id='+item+'my_tot value='+main_total+'> </td><td><input type="button" value="" id='+item+' style="width:30px;border:none;height:30px;background:url(images/edit_new.png)" class="round" onclick="edit_stock_details(this.id);"  /></td><td><input type=button value="" id='+item+' style="width:30px;border:none;height:30px;background:url(images/close_new.png)" class="round" onclick= $(this).closest("tr").remove() ></td></tr>').fadeIn("slow").appendTo('#item_copy_final');
    document.getElementById('quty').value="";
    document.getElementById('sell').value="";
    document.getElementById('stock').value="";
    document.getElementById('total').value="";
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Update Treatment</h3>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
				...
				if(isset($_GET['sid']))
				$id=$_GET['sid'];
				$line2 = $db->queryUniqueObject("SELECT * FROM patient_treatment INNER JOIN customer_details ON patient_treatment.patient_id=customer_details.patient_id WHERE invoice_id=$id");
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form table"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><input name="supplier" placeholder="Enter Patient Name" type="text" id="supplier"  maxlength="200"  class="round regular-width-input" value="<?php echo $line->customer_id; ?>"/></td>                       
                      <td>Date:</td>
                      <td><input  name="date" id="test1" placeholder="" value="<?php echo $line2->trt_date;?>" type="text" id="name" maxlength="200"  class="round regular-width-input"  /></td>
					  <td>Patient ID:</td>
					  <td><input name="pid" placeholder="" type="text" id="pid"  maxlength="200"  class="round small-width-input" value="<?php echo $line2->patient_id;?>" readonly /></td>
                      <td>Invoice ID:</td>
                       <td><input name="transactionid" type="text" id="transactionid" maxlength="200"  class="round small-width-input" value="<?php echo $line->transactionid; ?> " /></td>
                     </tr>
					<tr> 
					  ...
					  <td>
					   ...
					   <td><input type="text" name="duedate" id="test2" value="<?php echo $line2->next_appointment;?>" class="round">
					  </td> 
					  <td>Doc:</td>
					  <td><input name="doc" placeholder="Attending Doc" type="text" id="doc"  maxlength="200"  class="round regular-width-input" value="<?php echo $line2->doc;?>"/></td> 
					</tr>
                  </table>
				  <div class="col-lg-6" style="margin:2% 0;">
						<label for="pc" class="col-sm-2 control-label">P/C</label>
							<textarea name="pc"  cols="15" class="round full-width-textarea"><?php echo $line2->pc; ?></textarea>
						<label for="hpc" class="col-sm-2 control-label">HPC</label>
							<textarea name="hpc"  cols="15" class="round full-width-textarea"><?php echo $line2->hpc; ?></textarea>
						<label for="pmh" class="col-sm-2 control-label">PMH</label>
							<textarea name="pmh"  cols="15" class="round full-width-textarea"><?php echo $line2->pmh; ?></textarea>
					</div>
					<div class="col-lg-5" style="margin:2% 0;">
						<label for="oe" class="col-sm-2 control-label">OE</label>
							<textarea name="oe"  cols="15" class="round full-width-textarea"><?php echo $line2->oe; ?></textarea>
						<label for="dx" class="col-sm-2 control-label">DX</label>
							<textarea name="dx"  cols="15" class="round full-width-textarea"><?php echo $line2->dx; ?></textarea>
					</div>
                  </div>
				  <div class="col-lg-12">
                  ...
                  <input type="hidden" id="edit_guid">
                   ...
                   <table class="form table" id="display" style="display:none">
                       <tr >
                 
                      <td><input name=""  type="text" id="item"  maxlength="200"  class="round my_with " style="width: 250px; margin-left:12px;" value="<?php echo $supplier; ?>" /></td>
                       
                      <td><input name=""  type="text" id="quty"  maxlength="200"   class="round  my_with" style="width: 60px;" onKeyPress="quantity_chnage(event);return numbersonly(event)" onkeyup="total_amount();unique_check();" value="<?php echo $category; ?>"   /></td>
                      
                      
                      <td><input name=""  type="text" id="sell" readonly="readonly" maxlength="200"  class="round  my_with" style="width: 100px;" value="<?php echo $category; ?>" /></td>
                            
                                        
                      <td><input name=""  type="text" id="stock" readonly="readonly" maxlength="200"  class="round  my_with hidden"  value="<?php echo $category; ?>" /></td>
                      <td><input name=""  type="text" id="total" maxlength="200"  class="round regular-width-input " style="width:100px;  margin-left: 20px" value="<?php echo $category; ?>" /></td>
                  ...
                  <input type="hidden" id="edit_guid">
					...
					for($i=0; $i<=$max; $i++)
					{
                     ...
                     <tr>
                         ...
                         <td><input name="stock_name[]"  type="text" id="<?php echo $item."st"?>" maxlength="20" style="width: 250px;" readonly="readonly"  class="round "
                                 value="<?php echo $line1->stock_name ; ?>" /></td>
                  
                      <td><input name="quantity[]"  type="text" id="<?php echo $item."q"?>" maxlength="20"  style="width: 60px;" class="round my_with" 
                      ...
                      <td><input type="hidden" name="s_id[]" value="<?php echo $line1->id; ?>"> <input name="sell[]"  type="text" id="<?php echo $item."s"?>" maxlength="20" readonly="readonly" class="round my_with" style="width: 100px;"
					  value="<?php echo $line1->selling_price; ?>" onkeypress="return numbersonly(event)"  /></td>
                                        
                      <td><input name="total[]"  type="text" id="<?php echo $item."to"?>" readonly="readonly" maxlength="20" style="margin-left:20px;width: 120px"  class="round " style="width: 100px;"
                  ...
                  <table class="form table">
                    ...
                    <td>Discount Amount:<input type="text" readonly="readonly"  value="<?php echo $line->dis_amount ; ?>" onkeypress="return numbersonly(event);"  onkeyup=" discount_as_amount(); " class="round" id="disacount_amount" name="dis_amount" >               
                     ...
                     <td> &nbsp;</td><td> &nbsp;</td>
                        ...
                        <input type="text" id="main_grand_total" readonly="readonly"  value="<?php echo $line->grand_total ; ?>" class="round regular-width-input"  style="text-align:right;width: 120px" >
                    </td>
                  </tr> 
                    <tr> <td> &nbsp;</td>
                    ...
                    <td>Balance:<input type="text"  class="round" value="<?php echo $line->balance ; ?>" id="balance" name="balance" >               
                      ...
                      <td>Payable Amount:<input type="hidden" readonly="readonly" id="grand_total"  > 
                        <input type="text" id="payable_amount" value="<?php echo $line->subtotal ; ?>" readonly="readonly" name="payable" class="round regular-width-input"  style="text-align:right;width: 120px" >
                   </td>
                  </tr> </table> 
                                 <table class="form">
                    <tr>
