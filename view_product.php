...
<head>
	<meta charset="utf-8">
	<title>MedRec - View Services / Products</title>
...
{ 	     jConfirm('Sure You Want To Delete Product?', 'Confirmation Dialog', function (r) {
           if(r){ 
               console.log();
                $.ajax({
  			url: "delete.php",
  			...
  			success: function(data) {
    			window.location ='view_product.php';
                        ...
                        jAlert('Product Is Deleted', 'MedRec');
  			}
		});
            }
            return r;
...
return false;
 ...
 jConfirm('Sure You Want Delete Product?', 'Confirmation Dialog', function (r) {
           if(r){ 
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					<div class="content-module-heading cf">
						...
						<h3 class="fl">Services / Products</h3>
...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <!--<td> <?php $quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE name='".$row['stock_name']."'"); echo $quantity; ?></td>-->
    ...
    <td>	<a href="update_stock.php?sid=<?php echo $row['id'];?>&table=stock_details&return=view_product.php"><i class="btn btn-primary btn-xs fa fa-pencil"></i>
	</a>
	
<a  href="javascript:confirmSubmit(<?php echo $row['id'];?>,'stock_details','view_product.php')"><i class="btn btn-danger btn-xs fa fa-trash-o "></i></a>	
    </td>
