...
<head>
	<meta charset="utf-8">
	<title>EZ Stock - Add Supplier</title>
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form table"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td>Address</td>
                      <td><textarea name="address" placeholder="Enter Supplier Address"cols="8" class="round full-width-textarea"><?php echo $address; ?></textarea></td>
                        <td>Contact 2 </td>
