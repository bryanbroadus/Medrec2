...
{ 	     jConfirm('Sure You Want To Delete Patient?', 'Confirmation Dialog', function (r) {
           if(r){ 
               console.log();
                $.ajax({
  			url: "delete.php",
  			...
  			success: function(data) {
    			window.location = "view_customers.php";
                        ...
                        jAlert('Patient has been Deleted', 'MedRec');
  			}
		});
            }
            return r;
...
$SQL = "SELECT * FROM  customer_details WHERE customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_address LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%' OR patient_email LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%'";
...
$query = "SELECT COUNT(*) as num FROM  customer_details WHERE customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_address LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%' OR patient_email LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%'";
	...
	if(isset($_POST['Search']) AND trim($_POST['searchtxt'])!="")
{
	...
	$sql= "SELECT * FROM  customer_details WHERE customer_name  LIKE '%".$_POST['searchtxt']."%' OR customer_address LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%' OR patient_email LIKE '%".$_POST['searchtxt']."%' OR customer_contact1 LIKE '%".$_POST['searchtxt']."%'  LIMIT $start, $limit";
...
?>
   ...
   <td> <?php echo $row['balance'];?></td>
    <td>	<a title="View Patient Details" href="view_patient_record.php?sid=<?php echo $row['id'];?>&table=customer_details&return=view_customers.php&pid=<?php echo $row['patient_id']; ?>"><i class="btn btn-success btn-xs fa fa-eye"></i>
	</a><a title="Edit Patient Details" href="update_customer_details.php?sid=<?php echo $row['id'];?>&table=customer_details&return=view_customers.php&sid2=<?php echo $row['patient_id'];?>"><i class="btn btn-primary btn-xs fa fa-pencil"></i>	</a>
	<a title="Delete Patient Details"  href="javascript:confirmSubmit(<?php echo $row['id'];?>,'customer_details','view_customers.php')"><i class="btn btn-danger btn-xs fa fa-trash-o "></i></a>
	</td>
