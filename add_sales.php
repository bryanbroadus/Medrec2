...
if(isset($_POST['payment'])){
			...
			$db->query("insert into stock_sales (category,tax,tax_dis,discount,dis_amount,grand_total,transactionid,stock_name,selling_price,quantity,amount,date,username,customer_id,subtotal,payment,balance,due,mode,description,count1,billnumber) 
                            values('$cat',$tax,'$tax_dis',$discount,$dis_amount,$payable,'$autoid','$name1',$rate,$quantity,$total,'$mysqldate','$username','$customer',$subtotal,$payment,$balance,'$mysqldate','$mode','$description',$i+1,'$bill_no')");
			...
			$db->query("insert into stock_entries (stock_id,stock_name,quantity,opening_stock,closing_stock,date,due,username,type,category,salesid,total,selling_price,count1,payment,balance,billnumber) values('$stockid','$name1',$quantity,$amount,$amount1,'$mysqldate','$mysqldate','$username','sales','$cat','$autoid',$total,$rate,$i+1,$payment,$balance,'$bill_no')");
			...
			{
				echo "<br><font color=green size=+1 >There is not enough stock to deliver for $name1! Please add stock !</font>" ;
			}*/
			                      
			}		
                          $msg="Invoice Added successfully <br> Ref: ". $_POST['transactionid']."" ;
...
<head>
	<meta charset="utf-8">
	<title>MedRec - Add Invoice</title>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					//Gump is libarary for Validatoin
					 if(isset($_GET['msg'])){
                                                                              $data=$_GET['msg'];
                     $msg='<p style="color:#153450;font-size:1.2em;font-family:Verdana, Times New Roman, Times, san-serif;">'.$data.'</p><p><a href="add_sales.php"><i class="fa fa-3x fa-plus"></i> Create New Invoice</a></p><p> <a href="view_sales.php"><i class="fa fa-3x fa-shopping-cart"></i>View All Invoices</a></p>';//
                                            ?>
				...
				<form name="form1" method="post" id="form1" action="">
                  ...
                  <table class="form "  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>  <td>&nbsp; </td> <td>&nbsp; </td>
					  ...
					  ?>
                      <td>Invoice ID:</td>
                       <td><input name="transactionid" type="text" id="transactionid" maxlength="200"  class="round regular-width-input" readonly="readonly" value="<?php echo $autoid; ?>" /></td>
                      <td>Date:</td>
                      ...
                      <td><input name="bill_no" placeholder="Enter Bill Number" type="text" id="bill_no" maxlength="200"  class="round regular-width-input" /></td>
