...
<head>
	<meta charset="utf-8">
	<title>EZ Stock - Stock Categories</title>
...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <td> <?php echo $row['category_description']; ?></td>
    ...
    <td>	<a href="update_category.php?sid=<?php echo $row['id'];?>&table=category_details&return=view_category.php"><i class="fa fa-pencil"></i>
	</a>
	<a href="javascript:confirmSubmit(<?php echo $row['id'];?>,'category_details','view_category.php')" href=""><i class="fa fa-trash-o "></i></a>
	</td>
