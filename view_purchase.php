...
<head>
	<meta charset="utf-8">
	<title>EZ Stock - View Purchases</title>
...
{ 	     jConfirm('You Want To Delete This Purchase? ', 'Confirmation Dialog', function (r) {
           if(r){ 
               console.log();
                $.ajax({
  			url: "delete.php",
...
while($row = mysql_fetch_array($result))
 		...
 		$phpdate = date("d/m/Y",$phpdate);
										 ...
										 ?>
  											...
  											<tr>
                                                                                            ...
                                                                                            <td><?php echo $no+$i; ?></td>
		<td><?php $max=$line->id; $pid="PR".$max.""; echo $pid ?></td>
		...
		<td><a href="update_purchase.php?sid=<?php echo $entryid;?>&table=stock_entries&return=view_purchase.php"><i class="fa fa-pencil"></i>	</a></td>
		<td><a  href="javascript:confirmSubmit(<?php echo $line->id;?>,'stock_entries','view_purchase.php')"><i class="fa fa-trash-o "></i></a>    </td>
