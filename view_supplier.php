...
<head>
	<meta charset="utf-8">
	<title>Ez Stock - View Suppliers</title>
...
while($row = mysql_fetch_array($result)) 
{
 ?> 
   ...
   <td> <?php echo $row['balance'];?></td>
    <td>	<a href="update_supplier.php?sid=<?php echo $row['id'];?>&table=supplier_details&return=view_supplier.php"><i class="fa fa-pencil"></i>
	</a>
	
<a  href="javascript:confirmSubmit(<?php echo $row['id'];?>,'supplier_details','view_supplier.php')"><i class="fa fa-trash-o"></i></a>		
    </td>
