...
include_once("init.php");
	...
	$count = $db->countOf("stock_avail", "name='$stock_name[$i]'");
			...
			//VALUES (NULL, '$autoid1', '$stock_name[$i]', '$supplier', '', '$quantity', '$brate', '$srate', '$amount', '$amount1', '$mysqldate', 'sdd', 'entry', 'Sa45', '432.90', '2342.90', '24.34', 'cash', 'sdflj', '2010-03-25 12:32:02', '45645', '1');
                        ...
                        $msg="Purchase order Added successfully <br> Ref: ". $_POST['purchaseid']."" ;
...
<head>
	<meta charset="utf-8">
	<title>EZ Stock - Add Purchase</title>
			...
			<div class="side-content fr">
				...
				<div class="content-module">
					...
					//Gump is libarary for Validatoin
                                         if(isset($_GET['msg'])){
                                             $data=$_GET['msg'];
                                            $msg='<p style="color:#D51A10;font-family: Georgia, Times New Roman, Times, serif;">'.$data.'</p>';//
                                            ?>
            ...
            <div class="mytable_row2 ">
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td><input name="supplier" placeholder="Enter Supplier" type="text" id="supplier"  maxlength="200"  class="round regular-width-input"/></td>
                    ...
                    <tr>
					 <?php
					  ...
					  ?>
                      <td>Purchase ID:</td>
                      <td><input name="purchaseid" type="text" id="purchaseid" maxlength="200" readonly="readonly" class="round regular-width-input" value="<?php echo $pid ?>"/></td>
                      ...
                      <td><input name="bill_no" placeholder="Enter Bill No." type="text" id="bill_no" maxlength="200"  class="round regular-width-input" /></td>
                 ...
                 <td>&nbsp;</td>
                       ...
                       <td><input name="stockid" type="text" id="stockid" maxlength="200"  class="round regular-width-input" placeholder="Enter Stock ID"/></td>
                        <td><input name=""  type="text" id="quty"  maxlength="200"   class="round regular-width-input my_with" onKeyPress="quantity_chnage(event);return numbersonly(event);" onkeyup="total_amount();unique_check()"    /></td>
                     
                      <td><input name=""  type="text" id="cost" readonly="readonly" maxlength="200"  class="round regular-width-input my_with"   /></td>
                    ...
                    <tr> <td> &nbsp;</td>
                      ...
                      <td> &nbsp;</td><td> &nbsp;</td><td> &nbsp;</td><td> &nbsp;</td>
                       <td>Grand Total:<input type="hidden" readonly="readonly" id="grand_total" name="subtotal" > 
                           <input type="text" id="main_grand_total" class="round regular-width-input" onkeypress="return numbersonly(event)" readonly="readonly" style="text-align:right;" >
                    </td>
                  </tr> </table> 
                  <table>
                  <tr> <td>Mode &nbsp;</td><td>
